...
//search
if (isset($_POST["cari"])) {
    $pesanan = cari_user($_POST["keyword"]);
}
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="bg-light p-5 rounded">
                    ...
                    <a class="btn btn-primary text-white" href="tambah_pesanan.php">Tambah Pesanan</a><br>
                    <br>
                    <table class="table">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($pesanan as $row) : ?>
                                <tr>
                                    ...
                                    <td><?= $row["status"]; ?></td>
                                    <td>
                                        <a class="btn btn-warning text-white" href="ubah_pesanan.php?id_pemesan=<?= $row["id_pemesan"]; ?>">Ubah</a>
                                        <a class="btn btn-danger" href="hapus_pesanan.php?id_pemesan=<?= $row["id_pemesan"]; ?>" onclick="return confirm('yakin?');">Hapus</a>
                                    </td>
                                </tr>
                                <?php $i++; ?>
                            <?php endforeach; ?>
