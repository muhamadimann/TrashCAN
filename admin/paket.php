...
$jumlahData = count(query("SELECT * FROM paket"));
$jumlahHalaman = ceil($jumlahData / $jumlahDataPerHalaman);
$halamanAktif = (isset($_GET["halaman"])) ? $_GET["halaman"] : 1;
$awalData = ($jumlahDataPerHalaman * $halamanAktif) - $jumlahDataPerHalaman;

$paket = query("SELECT * FROM paket LIMIT $awalData, $jumlahDataPerHalaman");



//search
if (isset($_POST["cari"])) {
    $paket = cari_paket($_POST["keyword"]);
}
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="bg-light p-5 rounded">
                    ...
                    <a class="btn btn-primary text-white" href="tambah_paket.php">Tambah Paket</a><br>
                    <br>
                    <table class="table">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($paket as $row) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-warning text-white" href="ubah_paket.php?id_paket=<?= $row["id_paket"]; ?>">Ubah</a>
                                        <a class="btn btn-danger" href="hapus_paket.php?id_paket=<?= $row["id_paket"]; ?>" onclick="return confirm('yakin?');">Hapus</a>
                                    </td>
                                </tr>
                                <?php $i++; ?>
                            <?php endforeach; ?>
